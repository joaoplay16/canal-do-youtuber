package com.playlab.canaldoyoutuber.data.fixed
    ...
    companion object {
        ...
        fun getNetworks() = listOf(
            ...
            SocialNetwork(
                ...
                appUri = "linkedin://profile/vinícius-" +
                        "thiengo-5179b180",
                webUri = "https://www.linkedin.com/in/" +
                        "vin%C3%ADcius-thiengo-5179b180",
            ...
            SocialNetwork(
                ...
                accountName = "/vinícius-thiengo",
                appUri = "",
                webUri = "https://www.udemy.com/user/vinicius-" +
                        "thiengo/?persist_locale&locale=pt_BR",
            ...
            SocialNetwork(
                ...
                accountName = "/ThiengoCalopsita",
                appUri = "",
                webUri = "https://www.youtube.com/user/" +
                        "thiengoCalopsita",
