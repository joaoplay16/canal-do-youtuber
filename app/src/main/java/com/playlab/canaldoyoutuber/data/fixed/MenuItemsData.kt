...
import com.playlab.canaldoyoutuber.model.MenuItemStatus
    ...
    companion object {
        ...
        fun getItems(res: Resources) = listOf(
            ...
            MenuItem(
                ...
                label = res.getString(
                    R.string.item_menu_social_networks
                ),
            ...
            MenuItem(
                ...
                label = res.getString(
                    R.string.item_menu_exclusive_groups
                ),
            ...
            MenuItem(
                ...
                label = res.getString(
                    R.string.item_menu_about_channel
                ),
