package com.playlab.canaldoyoutuber.ui.adapter
...
import com.playlab.canaldoyoutuber.model.ListItem
...
class ListItemViewHolder(
    ...
    init {
        ...
        tvSecondAuxText = itemView.findViewById(
            R.id.tv_second_aux_text
        )
        tvMainText = itemView.findViewById(R.id.tv_main_text)
        tvFirstAuxText = itemView.findViewById(R.id.tv_first_aux_text)
        tvSecondAuxText = itemView.findViewById(
