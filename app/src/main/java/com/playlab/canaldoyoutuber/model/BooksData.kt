        ...
        fun getBooks() = listOf(
            Book(
                title = "Desenvolvedor Kotlin Android - " +
                        "Bibliotecas para o dia a dia",
                categories = listOf(
                    "Android",
                    "Kotlin"
                ),
                webPage = "https://www.thiengo.com.br/" +
                        "livro-desenvolvedor-kotlin-android",
            ...
            Book(
                ...
                webPage = "https://www.thiengo.com.br/livro-" +
            ...
            Book(
                ...
                webPage = "https://www.thiengo.com.br/porque-e-" +
                        "como-utilizar-vetores-no-android",
                cover = R.drawable.ic_book_cover_orange
            ),
            Book(
                title = "Construa Um Aplicativo Android Completo " +
                        "Para YouTubers",
                categories = listOf(
                    "Android",
                    "Kotlin",
                ...
                webPage = "https://www.thiengo.com.br/construa-" +
                        "um-aplicativo-android-completo-para-" +
                        "youtubers-parte-1",
                cover = R.drawable.ic_book_cover_orange
            )
        )
